...
CREATE TABLE `auto` (
  ...
  `hengerûrtartalom` int(11) NOT NULL COMMENT 'köbcentiméterben',
...
INSERT INTO `auto` (`rendszam`, `marka`, `modell`, `gyartasiev`, `forgalmiErvenyesseg`, `vetelar`, `kmallas`, `hengerûrtartalom`, `tomeg`, `teljesitmeny`) VALUES
